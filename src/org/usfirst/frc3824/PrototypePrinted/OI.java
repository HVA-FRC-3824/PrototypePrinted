...
public class OI
{
	...
	public OI()
	{
        ...
        shooterDisable = new JoystickButton(driveJoystick, 3);
        shooterDisable.whenPressed(new ShooterEnableDisable(false));
        shooterEnable = new JoystickButton(driveJoystick, 2);
        shooterEnable.whenPressed(new ShooterEnableDisable(true));
        ...
        SmartDashboard.putData("Shooter EnableDisable: ShooterEnable", new ShooterEnableDisable(false));
