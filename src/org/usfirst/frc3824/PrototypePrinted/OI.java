...
public class OI
{
	...
	public OI()
	{
        ...
        SmartDashboard.putData("ChassisTurnAngle: TurnRight90", new ChassisTurnAngle(90.0, .6));
        SmartDashboard.putData("ChassisTurnAngle: TurnRight45", new ChassisTurnAngle(45.0, .6));
