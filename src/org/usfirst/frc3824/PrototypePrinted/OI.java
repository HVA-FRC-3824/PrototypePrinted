...
public class OI
{
	...
	public OI()
	{
        ...
        SmartDashboard.putData("AutonomousLowBarShootBoulder: HighGoal", new AutonomousLowBarShootBoulder(true));
        SmartDashboard.putData("AutonomousLowBarShootBoulder: LowGoal", new AutonomousLowBarShootBoulder(false));
        ...
        SmartDashboard.putData("ChassisDriveStraightDistance: FourFeet", new ChassisDriveStraightDistance(48.0));
        SmartDashboard.putData("ChassisDriveTargetLIDAR: ShortShot", new ChassisDriveTargetLIDAR(48.0));
        SmartDashboard.putData("ChassisDriveTargetLIDAR: MediumShot", new ChassisDriveTargetLIDAR(68.0));
        SmartDashboard.putData("ChassisDriveTargetLIDAR: LongShot", new ChassisDriveTargetLIDAR(96.0));
        SmartDashboard.putData("ChassisTurnAngle: TurnRight90", new ChassisTurnAngle(90.0, 0.5));
        SmartDashboard.putData("ChassisTurnAngle: TurnRight45", new ChassisTurnAngle(45.0, 0.5));
        SmartDashboard.putData("ShootBoulderInGoal: LowGoal", new ShootBoulderInGoal(0.2, 0.4));
        SmartDashboard.putData("ShootBoulderInGoal: HighGoal", new ShootBoulderInGoal(0.8, 1.0));
        SmartDashboard.putData("ShooterShoot: ShootControl", new ShooterShoot(false));
        SmartDashboard.putData("ShooterWheelSpeedControl", new ShooterWheelSpeedControl());
        SmartDashboard.putData("ShooterWheelEnableDisable: ShooterEnable", new ShooterWheelEnableDisable(false));
        SmartDashboard.putData("ShooterElevationControl", new ShooterElevationControl());
